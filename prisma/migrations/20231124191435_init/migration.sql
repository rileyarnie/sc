/*
  ...
  - Added the required column `percentageSavings` to the `Product` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_Product" (
    ...
    "percentageSavings" INTEGER NOT NULL,
